...
- (void) setupAudioSession {
	...
	[[AVAudioSession sharedInstance] setPreferredIOBufferDuration: self.ioBufferDuration
	...
	*/
	...
	[[AVAudioSession sharedInstance] setPreferredHardwareSampleRate: self.graphSampleRate
...
// I/O Unit Setup
	...
	ioInputStreamFormat.mSampleRate			= 2 * self.graphSampleRate;
